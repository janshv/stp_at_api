...
class UserServiceServicer(user_service_pb2_grpc.UserServiceServicer):
    ...
    def GetNumber(self, request, context):
        print(f'Получен запрос к методу GetNumber от пользователя: ')
        return user_service_pb2.GetRandomNumberResponse(number=f"RND Number: {str(random.randint(1000, 2000))}")
