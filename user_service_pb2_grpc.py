...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetNumber = channel.unary_unary(
                '/userservice.UserService/GetNumber',
                request_serializer=user__service__pb2.GetRandomNumberRequest.SerializeToString,
                response_deserializer=user__service__pb2.GetRandomNumberResponse.FromString,
                _registered_method=True)
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetNumber': grpc.unary_unary_rpc_method_handler(
                    servicer.GetNumber,
                    request_deserializer=user__service__pb2.GetRandomNumberRequest.FromString,
                    response_serializer=user__service__pb2.GetRandomNumberResponse.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    def GetNumber(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/userservice.UserService/GetNumber',
            user__service__pb2.GetRandomNumberRequest.SerializeToString,
            user__service__pb2.GetRandomNumberResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
